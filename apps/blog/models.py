...
class Rating(models.Model):
    """
    Модель рейтинга лайк и дизлайк
    """
    ...
    time_create = models.DateTimeField(verbose_name='Время добавления', auto_now_add=True)
    ip_address = models.GenericIPAddressField(verbose_name='IP Адрес') # ip адрес в качестве атрибута выбран для того чтобы лайки могли ставить и незарегистрированный пользователи
